  ...
  <div class="flex mx-auto">
    <div class="lg:flex lg:justify-center lg:items-center flex flex-col mx-auto lg:flex-row">
      <div class="lg:flex-col flex flex-col mx-auto lg:w-2/5 lg:m-24 order-2 lg:order-1">
        <h1 class="text-3xl lg:text-6xl font-semibold mb-10 text-center lg:text-left">Welcome to GITS Commerce</h1>
      ...
      <div class="order-1 lg:order-2 flex mx-auto">
        <img class="max-w-[400px] max-h-[400px] md:max-w-[600px] md:max-h-[600px] xl:max-w-[800px] xl:max-h-[800px]" src="../assets/Jumbotron.png" alt="logo cart">
      </div>
    </div>
  </div>
</template>